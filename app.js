        ...
        chats.forEach(function (data) {
            ...
            if(chat.userId !== currentUserKey){
                ...
                <div class="col-2 col-sm-1 col-md-1">
                    <img src="${friendPhoto}" class="chat-pic rounded-circle" alt="">
                </div>
...
//                <p class="sent float-right">
//                   ${document.getElementById('txtMessage').value}
//                   <span class="time float-right">2:30 PM</span>
//                </p>
//              </div>
//              <div class="col-2 col-sm-1 col-md-1">
//               <img src="${firebase.auth().currentUser.photoURL}" class="rounded-circle chat-pic" alt=""/>
            ...
            if (friendKey !== "") {
                firebase.database().ref('users').child(friendKey).on('value', function (data) {
                    ...
                    document.getElementById('lstChat').innerHTML += `<li class="list-group-item list-group-item-action" onclick="StartChat('${data.key}', '${user.name}', '${user.photoURL}')">
                            <div class="row">
                                <div class="col-md-2">
                                    <img src="${user.photoURL}" class="profile-pic rounded-circle" />
                                </div>
        ...
        users.forEach(function (data) {
            ...
            if (user.email !== firebase.auth().currentUser.email) {
                list += ` <li class="list-group-item list-group-item-action" data-dismiss="modal" onclick="StartChat('${data.key}','${user.name}','${user.photoURL}')">
                             <div class="row">
                                <div class="col-md-2">
                                    <img src="${user.photoURL}" class="rounded-circle profile-pic" alt="">
                                 </div>
                                 <div class="col-md-10" style="cursor: pointer;">
                                    <div class="name">${user.name}</div>
                                 </div>
...
function onStateChanged(user) {
    if (user) {
        ...
        document.getElementById('imgProfile').src = 'user icon.png';
